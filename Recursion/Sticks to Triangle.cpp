// Sticks to Triangle
// 题目描述：
// You have several sticks with different lengths, what you need to do is to decide if those sticks can make one Equilateral triangle (Triangle with same length of all sides).
...
bool canFormTriangle(vector < int > sticks) {
    return formPolygon(sticks, 3);
}
/******************************结束写代码******************************/
